        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="${getBaseUrl()}/" class="hover:opacity-90 transition-opacity duration-300">
                        <img src="${getBaseUrl()}/assets/msingiailogo.jpeg" alt="Msingi AI - Building AI That Understands Africa" class="h-12 w-auto" />
                    </a>
                </div>
